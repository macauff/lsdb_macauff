    ...
    for index, args in enumerate(required_args):
        ...
        with pytest.raises(ValueError, match=args[0]):
            MacauffArguments(
                ...
                left_assn_column=test_args[6],
                right_catalog_dir=test_args[7],
                right_id_column=test_args[8],
                right_assn_column=test_args[9],
